...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Complaint  Details</span></h2>
            ...
            <table width="200" border="1">
              <tr>
                <td><span class="style16">
                  <label for="checkbox_row_1">Complaint_id</label>
                </span></td>
                <td><span class="style16">
                  <label for="checkbox_row_2">Complaint_name</label>
                </span></td>
                <td><span class="style16">
                  <label for="checkbox_row_3">Date</label>
                </span></td>
                <td><span class="style16">
                  <label for="checkbox_row_4">Address</label>
                </span></td>
                <td><span class="style16">
                  <label for="checkbox_row_5">Product_name</label>
                </span></td>
                <td><span class="style16">
                  <label for="checkbox_row_6">Remarks</label>
                </span></td>
              ...
              <tr>
                ...
                <td><a href=complaint_dlt.jsp?complaint_id=<%=rs.getString(1) %>>  Delete </a></td>
              </tr>
              <%
              }
              %>
