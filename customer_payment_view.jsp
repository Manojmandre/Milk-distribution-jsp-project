    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <%
          ResultSet rs =stmt.executeQuery("select * from customer_payment");
          %>
            <table width="200" border="1">
              <tr>
                ...
                <td><span class="style1">
                  <label for="checkbox_row_2">Customer_id</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_3">Price</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_4">Payment_mode</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_5">Activity</label>
                </span></td>
              ...
              %>
                ...
                <td><a href=customer_payment_dlt.jsp?order_id=<%=rs.getString(1) %>>  Delete </a></td>
              </tr>
              <% 
              }
              %>
