    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		 ...
		 // out.println(id);
		  ResultSet res=stmt.executeQuery("select * from contractor_order where agent_id='"+id+"' ");
		  %>
          </p>
          <p>&nbsp;</p>
          <form method="post" action="areawise_sales_view.jsp">
            <table width="580" border="1">
              <tr>
                <td bgcolor="#0000FF"><span class="style4">Product Type</span></td>
                <td bgcolor="#0000FF"><span class="style4">Total Quantity</span></td>
                <td bgcolor="#0000FF"><span class="style4">Total Price</span></td>
              </tr>
              <%
			  while(res.next())
			  {
			  %>
              <tr>
                <td bgcolor="#FFFFFF"><span class="style5"><%=res.getString("product_type")%></span></td>
                <td bgcolor="#FFFFFF"><span class="style5"><%=res.getString("quantity")%></span></td>
                <td bgcolor="#FFFFFF"><span class="style5"><%=res.getString("total_price")%>	</span></td>
              </tr>
              <%
			  }
			  %>
