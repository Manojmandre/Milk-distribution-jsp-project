            ...
            <table width="200" border="1">
              <tr>
                <td><span class="style1">
                  <label for="checkbox_row_1">Emp_id</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_2">Emp_Name</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_3">Address</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_4">Dept</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_5">Role</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_6">email</label>
                </span></td>
                <td><span class="style1">
                  <label for="checkbox_row_7">Phno</label>
                </span></td>
              ...
              %>
                ...
                <td><a href=empdetails_dlt.jsp?emp_id=<%=rs.getString(1) %>>  Delete </a></td>
              </tr>
              <% 
              }
              %>
